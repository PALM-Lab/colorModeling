...
* The data file ("colorPercData_clean.csv") - [downloadable here](https://github.com/WilliamNgiam/orientationModeling/blob/main/data/oriPercData_clean.csv).
* The model text file ("colorPerceptualReproduction_jags.txt") - [downloadable here](https://github.com/WilliamNgiam/orientationModeling/blob/main/perceptualReproduction/perceptualReproduction_jags.txt).
...
percData <- read_csv(paste0(getwd(),"/color data/colorPercData_clean.csv"))
...
bayes.mod.fit <- jags(data = data.jags,
                      ...
                      n.iter = 8000,
                      n.burnin = 2000,
                      model.file = paste0(getwd(),"/colorPerceptualReproduction_jags.txt"))
