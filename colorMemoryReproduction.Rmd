...
memData <- read_csv(paste0(getwd(),"/color data/colorWMData_clean.csv"))
...
bayes.mod.fit <- jags(data = data.jags,
                      ...
                      n.burnin = 2000,
                      n.thin = 10,
                      model.file = paste0(getwd(),"/colorMemoryReproduction_jags.txt"))
